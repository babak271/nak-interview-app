<form action="{{ route('posts.comments.store',$post) }}" method="post">
	...
	<div class="col-md-12">
		...
		<div class="stars">
			<label class="rate">
				<input type="radio" name="rate" id="star1-{{ $post->id }}" value="1">
				<div class="face"></div>
				<i class="far fa-star star one-star"></i>
			</label>
			<label class="rate">
				<input type="radio" name="rate" id="star2-{{ $post->id }}" value="2">
				<div class="face"></div>
				<i class="far fa-star star two-star"></i>
			</label>
			<label class="rate">
				<input type="radio" name="rate" id="star3-{{ $post->id }}" value="3">
				<div class="face"></div>
				<i class="far fa-star star three-star"></i>
			</label>
			<label class="rate">
				<input type="radio" name="rate" id="star4-{{ $post->id }}" value="4">
				<div class="face"></div>
				<i class="far fa-star star four-star"></i>
			</label>
			<label class="rate">
				<input type="radio" name="rate" id="star5-{{ $post->id }}" value="5">
				<div class="face"></div>
